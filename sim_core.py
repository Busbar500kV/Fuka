...
class Engine:
    ...
    def step(self, t: int) -> Tuple[float, float, float]:
        ...
        left  = np.roll(prev,  1); right = np.roll(prev, -1)
        ...
        self.hist.t.append(t); self.hist.E_cell.append(E_cell)
        self.hist.E_env.append(E_env); self.hist.E_flux.append(E_flux)
